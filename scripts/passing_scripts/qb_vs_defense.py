...
pbp_p = (
    ...
    .groupby(["passer_id", "passer","offense_formation","defteam",
              #"defenders_in_box",
              #"number_of_pass_rushers",
              "defense_man_zone_type"
              ])
    .agg({"yards_gained": [ "mean"],"air_yards": [ "mean"],"play_id" :["count"],"epa": [ "mean"],"play_id" :["count"]})
)
...
sort_crit = "play_id_count > 10"
sorted_pbp_p = pbp_p.query(sort_crit).sort_values(by="passer", ascending=False)
